...
<!DOCTYPE html>
    ...
    <body>
      ...
      <tr>
         ...
         <td><?php echo $row['Tên SV'];?></td>
         <td><?php echo $row['MSV'];?></td>
         <td><?php echo $row['Mã học phần'];?></td>
         <td><?php echo $row['Tên học phần'];?></td>
         <td><?php echo $row['Số tín chỉ'];?></td>
         <td><?php echo $row['Điểm Qtrinh'];?></td>
         <td><?php echo $row['Điểm thi'];?></td>
         <td><?php echo $row['TKPH'];?></td>
         <td><?php echo $row['Điểm chữ'];?></td>
         <td><?php echo $row['Năm học'];?></td>
         <td><?php echo $row['Học kỳ'];?></td>
         <td><?php echo $row['Giai đoạn'];?></td>
