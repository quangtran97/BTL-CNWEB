  ...
  <div class="row content">
    ...
    <div >
        <?php
            if(isset($_POST['submit'])){
                if(empty($_POST['Tensinhvien']) || empty($_POST['MSV'])|| empty($_POST['Lớp'])||empty($_POST['Khoa'])){
                    ...
                    $Khoa=$_POST['Khoa'];
                     ...
                     $sql="select * from danhsachsv where MSV='$MSV'";
                     $query= mysqli_query($con,$sql);
                     $num =mysqli_num_rows($query);
                     if($num==1){
                        echo '<p style="color:red">Mã sinh viên đã tồn tại</p>';
                     }else{
                    $sql2= "INSERT INTO danhsachsv (Tensinhvien, MSV, Lớp,Khoa) VALUES ('$Tensinhvien', '$MSV', '$Lớp','$Khoa')";
    ...
    <form action="" method="POST">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="masv" placeholder="Tên Sinh Viên..." >
            <label for="">Mã Sinh Viên:</label>
            <input type="text" class="form-control" name="tensv" placeholder="Mã Sinh Viên..." >
            <label for="">Lớp:</label>
            <input type="text" class="form-control" name="tenlop" placeholder="Lớp..." >
            <label for="">Khoa:</label>
            <input type="text" class="form-control" name="tenlop" placeholder="Khoa..." >
